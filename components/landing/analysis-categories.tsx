...
export async function AnalysisCategories() {
  ...
  const categories = [
    ...
    },
    {
      ...
      title: 'Database',
      count: 8,
      description: 'Analyze query patterns, connection handling, indexing, and transaction usage.',
      items: ['Query optimization', 'Connection pooling', 'Index analysis', 'Transaction patterns'],
      color: 'purple',
    },
    {
      icon: Zap,
      title: 'Performance',
      count: 6,
      description: 'Identify caching issues, N+1 queries, and performance bottlenecks.',
      items: ['Cache strategies', 'N+1 query detection', 'Response time analysis', 'Resource usage'],
      color: 'yellow',
    },
    {
      icon: AlertTriangle,
      ...
      count: 5,
      description: 'Review error handling patterns, try-catch usage, and error propagation.',
      items: ['Error boundaries', 'Try-catch patterns', 'Error logging', 'Recovery strategies'],
      color: 'orange',
    },
    {
      icon: Server,
      title: 'Deployment',
      count: 6,
      description: 'Check deployment configurations, environment variables, and infrastructure setup.',
      items: ['Docker configuration', 'CI/CD pipelines', 'Environment setup', 'Scaling config'],
      color: 'green',
    },
    {
      icon: Cpu,
