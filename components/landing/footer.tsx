        ...
        <div className="grid md:grid-cols-4 gap-16 mb-16">
          <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-4">
              <a href="#" className="w-9 h-9 bg-amber-500/10 border border-amber-500/20 rounded-lg flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-amber-500/40 transition-colors duration-200">
