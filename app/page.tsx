      ...
      <div className="min-h-[90vh] flex flex-col items-center justify-center px-4 relative overflow-hidden pt-32">
        ...
        <main className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed mb-8">
            Point it at any <span className="text-foreground font-medium">public GitHub repository</span> and get an AI-generated verdict — health score, security findings, deployment risks, and prioritised fixes.
          </p>
